...
path_orig = 'C:/Users/Egor/Desktop/temperature_okhotskoe/original.csv'
...
def new_date():
    ...
    new_orig_copy.to_csv('C:/Users/Egor/Desktop/temperature_okhotskoe/new_orig_copy.csv', index=False)
    print('OK')
...
def cutter_orig_file():
    ...
    """
    new_df = pd.read_csv('C:/Users/Egor/Desktop/temperature_okhotskoe/new_orig_copy.csv', delimiter=',')
        ...
        if year in list(new_df['Year']):
            ...
            for month in range(1, 13):
                if month in list(new_df.query('Year == @year')['Month']):
                    ...
                    df.to_csv('C:/Users/Egor/Desktop/temperature_okhotskoe/cutter/'+f'{year}_{month}.csv', index=False)
...
def cleaning_cuttered_files():
    ...
    for year in range(1930, 2016):
        if year in list(new_df['Year']):
            for month in range(1, 13):
                if month in list(new_df.query('Year == @year')['Month']):
                    path_lonely_csv = 'C:/Users/Egor/Desktop/temperature_okhotskoe/cutter/' + f'{year}_{month}.csv'
                    ...
                    df.to_csv('C:/Users/Egor/Desktop/temperature_okhotskoe/cutter/' + f'{year}_{month}_without_Nan_0_Extremal.csv',
                              index=False)
                    print('OK')
...
def number_station():
    ...
    for year in range(1930, 2016):
        if year in list(new_df['Year']):
            for month in range(1, 13):
                if month in list(new_df.query('Year == @year')['Month']):
                    path_df_new = 'C:/Users/Egor/Desktop/temperature_okhotskoe/cutter/' + f'{year}_{month}_without_Nan_0_Extremal.csv'
                    ...
                    path_df_with_nst = 'C:/Users/Egor/Desktop/temperature_okhotskoe/cutter/nst/' + f'{year}_{month}_nst.csv'
...
def joiner_clean_files():
    ...
    path_last = 'C:/Users/Egor/Desktop/temperature_okhotskoe/cutter/joined/1930_6_nst.csv'
    df_last = pd.read_csv(path_last, header=0, delimiter=',')

    new_orig_copy_df = pd.read_csv('C:/Users/Egor/Desktop/temperature_okhotskoe/new_orig_copy.csv', delimiter=',')
    for year in range(1931, 2016):
        if year in list(new_orig_copy_df['Year']):
            for month in range(1, 13):
                if month in list(new_orig_copy_df.query('Year == @year')['Month']):
                    path_df_new = 'C:/Users/Egor/Desktop/temperature_okhotskoe/cutter/nst/'+f'{year}_{month}_nst.csv'
                    df_new = pd.read_csv(path_df_new, delimiter=',')

                    df_last = pd.concat([df_last, df_new])
                    df_last.to_csv('C:/Users/Egor/Desktop/temperature_okhotskoe/cutter/joined/1930_6_nst.csv', index=False)
    print('ok')
