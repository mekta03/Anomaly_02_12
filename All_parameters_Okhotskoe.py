        ...
        if year in list(new_df['Year']):
            ...
            for month in range(1, 13):
                if month in list(new_df.query('Year == @year')['Month']):
                    ...
                    df.to_csv('C:/Users/Egor/Desktop/all_parameters_okhotskoe/cutter/'+f'{year}_{month}.csv', index=False)
...
def number_station():
    ...
    for year in range(1930, 2016):
        if year in list(new_df['Year']):
            for month in range(1, 13):
                if month in list(new_df.query('Year == @year')['Month']):
                    path_df_new = 'C:/Users/Egor/Desktop/all_parameters_okhotskoe/cutter/' + f'{year}_{month}_without_Nan_0_Extremal.csv'
...
def joiner_clean_files():
    ...
    path_last = 'C:/Users/Egor/Desktop/all_parameters_okhotskoe/cutter/joined/1930_6_nst.csv'
        ...
        if year in list(new_orig_copy_df['Year']):
            for month in range(1, 13):
                if month in list(new_orig_copy_df.query('Year == @year')['Month']):
                    path_df_new = 'C:/Users/Egor/Desktop/all_parameters_okhotskoe/cutter/nst/'+f'{year}_{month}_nst.csv'
